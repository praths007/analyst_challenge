...
outlier_treated_train_data[,mdistance := round(mdistance, 1)]

outlier_treated_train_data[,moutlier := ifelse(mdistance > 20, 1, 0)]
# around 88 rows are tagged as outliers, as these are very low in number we can remove them from the dataset
